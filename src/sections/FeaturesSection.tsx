...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumbnail that get clicks, without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img className="h-full w-auto" src="/assets/features-showcase-1.pnmg" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop guessing and start ranking.Our AI creates desings proven to capture attention.</p>
